...
![Figure 4.1](images/figure4-1.png)
...
![Figure 4.2](images/figure4-2.png)
...
![Figure 4.3](images/figure4-3.png)
...
![Figure 4.5 Inter-Pod communication](images/figure4-5.png)

<figcaption>Figure 4.5 Inter-Pod communication</figcaption>

如前所述，*吊舱内部*通信——同一吊舱中的两个容器需要通信——可以通过吊舱的`localhost`接口进行。

![Figure 4.6 Intra-Pod communication](images/figure4-6.png)
...
![Figure 4.7 Pod lifecycle](images/figure4-7.png)
...
![Figure 4.8](images/figure4-8.png)

...
你想在谷歌Kubernetes搜索引擎(GKE)上创建一个Kubernetes集群。
...
<sup>[【2】](#idm139735600719152-marker)</sup>织工，[【阿多整合Kubernetes】](https://www.weave.works/docs/net/latest/kube-addon/)。

【free desktop . org】[【系统】](https://www.freedesktop.org/wiki/Software/systemd/)。

<sup>[4](#idm139735595020784-marker)</sup> Kubernetes艰难之路，[【启动Kubernetes控制平面】](https://github.com/kelseyhightower/kubernetes-the-hard-way/blob/master/docs/08-bootstrapping-kubernetes-controllers.md?)。
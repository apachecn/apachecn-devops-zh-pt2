...
![](assets/b0a4b0a1-5d0b-467a-8027-c23e7a0b972d.png)
...
![](assets/eb1cb350-5f48-4da0-9990-574cc1f58aae.png)
...
![](assets/570e760b-4ffa-4ecf-a854-d552cfbab98c.png)
...
![](assets/ad13b529-964b-49e8-8597-de51cc5f9edb.png)
...
![](assets/5fa27a7f-8af4-4b69-ac32-1837119a24db.png)
...
![](assets/e4ed078e-6bb7-4908-9eb9-bb8a33c4d258.png)
...
![](assets/6516dce2-6200-447b-ab62-59d2da30d6fd.png)
...
为了读取我们的测试数据，我们需要构建应用程序 Docker 映像，并创建一个在`mongo-cluster`网络中运行的容器。为此，请执行以下步骤:
...
![](assets/83cccc9f-2049-48f4-98ff-0f8405a01987.png)

如果您有兴趣，可以在 Azure Portal([https://portal.azure.com/](https://portal.azure.com/))上查看 SMB 共享包含的内容:

![](assets/cc802dbb-7896-4eb4-bf0a-120893c9cce9.png)

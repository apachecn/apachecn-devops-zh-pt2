...
例如，**鞭炮**([https://firecracker-microvm.github.io/](https://firecracker-microvm.github.io/))通过**鞭炮容器**([https://github . com/鞭炮-微伏/鞭炮容器](https://github.com/firecracker-microvm/firecracker-containerd))与容器集成。谷歌 gVisor 是另一个沙盒技术。它是一个用户空间内核，实现大多数 Linux 系统调用，并在应用程序和主机操作系统之间提供缓冲区。也可通过容器通过**容器垫片**([https://github.com/google/gvisor-containerd-shim](https://github.com/google/gvisor-containerd-shim))获得。

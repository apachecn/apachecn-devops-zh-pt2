...
在本章中，我们将使用 Ansible 附带的各种核心模块来部署完整的 LAMP 栈。我们将瞄准我们在[第 2 章](02.html#SJGS0-0fda9dda24fc45e094341803448da041)、*安装和运行Ansible的*中部署的 CentOS 7 游民箱。
...
还有一种常见的 LAMP 栈变体叫做**LEMP**；这将*阿帕奇*替换为 *NGINX* ，发音为 *engine-x* ，因此为 *E* 而非 *N* 。
...
我们正在组装的栈的最后一个元素是 PHP。与其他三个元素一样，我们需要使用`ansible-galaxy init`命令创建一个角色:

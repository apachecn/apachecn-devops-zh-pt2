...
![](assets/c388ef23-1f69-40d2-a983-42c7b21799ab.png)
...
![](assets/8eb0b063-68fb-418e-b9c6-b45879177165.png)
...
![](assets/1bffa5bc-ac35-4f21-8e01-0da4e62e70ed.png)
...
![](assets/a7092346-4b95-4bc0-9b03-8027aa02a028.png)
...
![](assets/07ef2905-934e-497f-814b-5ee8faa224cb.png)
...
![](assets/f92c9053-3e6a-4941-bec1-9c93e4928021.png)
...
![](assets/67b863ed-45cd-4655-91f6-0d644678fcc3.png)
...
![](assets/681ea04e-51d7-456d-b1b3-19dac463851e.png)
...
![](assets/52d88be7-996f-4e3c-8b54-c8ca422dbfca.png)
...
![](assets/215c91ff-4195-4672-b353-d5925c579232.png)
...
詹金斯管道语法实用程序是创建管道代码的一种快速简单的方法。詹金斯管道作业中提供了管道语法实用程序；参见截图:*中的*管道部分*创建詹金斯管道作业*部分。
...
![](assets/07b30830-4890-49f6-a5f0-6819920ed7d8.png)
...
![](assets/12f17ad1-9799-48c0-a068-f549aee9f96d.png)
...
![](assets/556cd5db-89a7-4e8e-a5d3-ce4f4c1d2134.png)
...
![](assets/a87158b7-ea52-49bd-9524-6a261293bd40.png)
...
![](assets/66cfb4d4-15f8-4606-b75d-411ace6d2dca.png)
...
![](assets/914137d6-09d6-4dbe-8717-fee3eb2c4272.png)
...
![](assets/a41af0e7-4edc-469c-8560-f9a78870677d.png)
...
![](assets/217cebfe-e260-4304-93f5-d889d44b1a87.png)
...
![](assets/bded462a-1af0-404d-be0f-f3a8801d5929.png)

Configuring the GitHub server

![](assets/744b89ff-b93b-4f11-b12f-d6a0b37b7c82.png)

Converting GitHub credentials to a token

![](assets/cbf2a483-2824-49d9-bd2a-387746ca4378.png)
...
![](assets/291edace-fbc8-4019-86d9-33ce33147f9e.png)
...
![](assets/5bd1269f-e7c5-4deb-9539-d56cfd68c552.png)
...
詹金斯多分支管道利用詹金斯文件。在下一节中，我们将学习如何创建詹金斯文件。我们将重用上一节中创建的示例管道脚本来创建我们的詹金斯文件。遵循给定的步骤:

1.  登录您的 GitHub 帐户。
2.  导航到分叉存储库`simple-maven-project-with-tests`。
3.  进入存储库页面后，单击创建新文件按钮创建一个新的空文件，该文件将成为我们的詹金斯文件，如下图所示:

![](assets/c234ca79-7f1d-4226-b82f-80b41a840224.png)

Creating a new file on GitHub

4.  通过填充空文本框命名新文件`Jenkinsfile`，如下图所示:

![](assets/c675a921-39a3-49b9-aabb-fe67a1fd15c1.png)
...
![](assets/08f388a0-b80e-4a77-9e19-a0bfceb62bd5.png)
...
![](assets/ba73d472-a2e6-4325-b0d6-9ff7473f7dde.png)
...
在我们继续之前，让我们为我们所有的詹金斯管道重新注册网络钩子:
...
![](assets/7a121a00-fd4e-4e2b-be87-c15c71682dbf.png)

Repository Settings

![](assets/1cf38c2d-ea47-4dd5-83cc-fc14f1293e99.png)
...
![](assets/3c984c63-c412-4014-b825-6cb7e4b44915.png)
...
![](assets/31a82eea-cea0-4969-8c9e-b7a04eac784e.png)

Creating a feature branch

4.  这将立即在 Jenkins 内部为我们的新功能分支触发一个管道:

![](assets/f5f0288c-1c06-48b8-9527-95e393ddb72b.png)
...
为了使用詹金斯蓝海插件，我们需要为詹金斯安装蓝海插件。遵循给定的步骤:

1.  在詹金斯仪表板中，单击管理詹金斯|管理插件。
2.  在插件管理器页面上，单击可用选项卡。
3.  使用过滤器选项，搜索`Blue Ocean`，如下图所示:

![](assets/a3d06a2a-b8bb-4b8b-8e35-b1511823c3cd.png)
...
![](assets/f26e0fa8-013f-44cd-b9a8-0791e1f15a17.jpg)
...
![](assets/5548fc62-2dcc-4550-bd8a-edcf3e4a707a.png)
...
![](assets/01fd4966-37d1-40c6-9c54-7ef5e000d399.png)
...
![](assets/55b94284-373e-44f3-8bd4-5e30f5cd072f.png)

Creating a GitHub personal access token

6.  单击页面底部的生成新令牌按钮，以生成新的个人访问令牌:

![](assets/b7e44237-4861-4ead-811b-42b07f049941.png)
...
![](assets/7c2f49fa-0990-43d1-ae5c-6d72df4a8f24.png)

Choosing the GitHub account

9.  您可以在新建管道和自动发现詹金斯文件之间进行选择。在以下示例中，我们将选择“新建管道”选项:

![](assets/f80bbc23-0d04-4466-b8b0-b28431161e58.png)
...
![](assets/df613709-fff8-43f3-8c22-ef983f80ebc8.png)
...
![](assets/36e5ad2e-5acb-4a12-baf1-d411358a2448.png)
...
![](assets/2444cf20-af88-4797-8641-8b27ea578039.png)
...
![](assets/462127ca-1063-40c0-83f8-9e4eeafa04f8.png)
...
![](assets/5fd8d643-d437-4b57-8007-b7a52775c966.png)

Configuring the shell script child step

24.  单击后退箭头返回上一菜单。现在，您应该会看到您的新步骤，Shell 脚本，列在子步骤部分下，如下图所示:

![](assets/d618fee6-8dcc-4e49-84a2-97a059e7cc1b.png)
...
![](assets/b87fc35f-5019-4191-97f4-a4db8544f0fe.png)
...
![](assets/6a3c778c-5119-4f4e-b8d9-9ded7acdc861.png)
...
![](assets/f17fe23c-febf-4f0c-b1f7-573cc281eff7.png)
...
![](assets/2f417715-7ed2-4b52-a99e-48809e1142e9.png)

Saving the pipeline

37.  这将立即在相应的分支上运行管道，如下图所示:

![](assets/c867af3e-263f-4385-a770-3e41b7eecb00.png)

A successful build on the master branch

38.  您会注意到在主分支下的存储库中已经创建了一个新文件:

![](assets/4944eed5-23ef-4c32-98e2-8a1098d7fbb0.png)

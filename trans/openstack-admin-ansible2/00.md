...
[第九章](09.html "Chapter 9. Inventory Your Cloud")、*盘点你的云*，探索读者如何用一个 Ansible 剧本动态盘点所有 OpenStack 云用户资源。它引导他们通过必要的度量标准来收集信息，以及如何存储这些信息以供以后参考。作为云管理员/操作商，这是一个非常强大的工具。

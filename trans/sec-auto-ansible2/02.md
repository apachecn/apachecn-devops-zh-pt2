...
![](assets/c7d7e4ae-5685-4cd2-b4aa-fbb1f6e6dd35.png)
...
![](assets/5754dba5-fa69-4104-9f99-8777b6372c2a.png)
...
![](assets/5d64f647-7035-4b4f-929d-25e92ffadc07.png)
...
![](assets/129dc8fb-abed-4a43-853a-5a00bf690e8d.png)

登录后，它会提示您输入 Ansible Tower 许可证:

![](assets/7046a7ee-92b0-49ba-8cf5-05e48c05cd10.png)

Ansible Tower 还提供了**基于角色的身份验证控制** ( **RBAC** )，为不同的用户和组管理 Tower 提供了细粒度的控制。下面的屏幕截图显示了正在创建的具有系统管理员权限的新用户:

![](assets/d59cb20b-cb31-40c8-8cb6-4e551ec6a913.png)
...
![](assets/567b4e71-7c73-4b16-b147-56168d855c54.png)
...
![](assets/78d67f33-0a8a-440d-a564-5ad6814bf7f0.png)

收集库存后，我们可以创建作业来执行行动手册或临时命令操作:

![](assets/4c1877ad-17b2-4efe-b7e8-674c83e238c9.png)

这里，我们选择了`shell`模块，并对两个节点运行`uname -a`命令:

![](assets/fc8e0186-52a9-4dce-b9f7-a65a0e4c3183.png)

一旦我们启动执行，我们可以在仪表板中看到标准输出。我们还可以使用 REST 应用编程接口来访问它:

![](assets/3ff8c0c0-ec93-40ec-923a-60daef08eb5b.png)
...
![](assets/e933fb26-6493-48e9-b312-e52850dbcda8.png)
...
![](assets/c8287e07-3bd9-4c2c-93c0-f1101585a763.png)

现在我们可以创建一个新项目来开始工作。提供一个新的项目名称，现在使用默认设置:

![](assets/08461d41-6711-4464-8591-a6d421ca287b.png)

现在，我们可以将多个主机添加到 Rundeck 中来执行多个操作。下面的截图展示了一个跨多个节点运行`uname -a`命令的例子，与`osArch: amd64`匹配，我们也可以为不同的用例创建过滤器:

![](assets/2d416d9a-ffe1-45d0-beb7-05149da3c0d1.png)
...
![](assets/554af815-f886-4992-9ff5-d82187098819.png)
...
**![](assets/c33ce511-85d7-4df6-b2c0-5d1edf3052e8.png)** Playbook execution job template 

作业运行成功，输出如下图所示:

![](assets/fe07b80e-0344-4855-a6f8-5f3e1dbdd6b0.png)
...
![](assets/525750e9-851f-4874-be36-3c44b66ec960.png)

Rundeck has multiple options for us to choose from

![](assets/6e072793-3c21-494b-9ad5-e2befc0fa520.png)

Rundeck Ansible Playbook configuration for variables and keys

![](assets/8baeae91-7dfc-441e-be3b-becacc09fc15.png)
...
![](assets/10acb85d-52aa-4b55-8780-f959c561b05b.png)
...
![](assets/c745e9a1-51da-4ea4-bb21-0d3b65ed6b4c.png)
...
![](assets/0c385f10-eced-4595-8d00-6e8fcfab0550.png)
...
![](assets/b8421697-957d-4527-a83c-bd6fe22d6635.png)

Ansible Tower dashboard

![](assets/ae0d5c7e-73d7-4508-aa80-ed924e9c1699.png)

Ansible Tower standard output

![](assets/adfa2820-d792-48fb-8012-0e03a7eb070f.png)
...
![](assets/15fd8b11-130c-42e3-9def-8c0b684f6d18.png)
...
![](assets/f50f2cbf-da86-4ca6-ac4f-184e84d63b84.png)
...
![](assets/de4acb14-dd56-484a-9dc7-3092d583ff66.png)

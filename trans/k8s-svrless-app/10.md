...
千万不要在任何地方发布(也就是比如签入 GitHub，或者和同事分享)。如果它落入坏人之手，那么不仅有人拥有您的证书副本，他们还拥有您的其他群集信息，这意味着他们所要做的就是将它放在本地计算机上，然后他们就可以自由地启动应用。此外，由于大多数基于云的 Kubernetes 安装都可以访问您的云提供商来启动支持服务，如负载平衡器、存储和潜在的额外节点，因此您可能会发现自己的账单相当大，而且集群也受到影响。

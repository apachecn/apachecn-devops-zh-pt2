...
![](assets/73ea44f8-68d1-4197-962d-3b497f021eb6.png)
...
![](assets/933c7985-dd0c-4010-a221-d6acaa57caba.png)

请注意，Travis CI 为我们推送的新分支创建了一个名为`add-test-case`的新构建:

![](assets/0eabe7cd-20b0-4415-8879-45ed92acfda0.png)

此外，您打开的任何拉取请求也将触发 Travis CI 的新构建:

![](assets/36d2d694-5a55-4915-9df5-df947dbd5053.png)
...
![](assets/47a341db-4274-42f7-a727-8792e62b97ae.png)
...
![](assets/8e2cbf8f-4bfa-4e57-baa5-775adf237d4c.png)
...
![](assets/95869538-b91b-451b-89d0-da480536f6a0.png)
...
![](assets/dde63ac8-9b9e-4a90-b717-0ef3fb282096.png)
...
![](assets/8baf12ee-0bd1-46c6-98b0-28c3f514339a.png)

# 从“查看配置”按钮中的网址获取作业标识

如果您单击查看配置按钮，网址将会改变，您可以从网址复制作业标识。在下面的截图中，我们单击了视图配置按钮，如下所示:

![](assets/19b95e3a-9069-47c5-bd37-4191deddef41.png)
...
![](assets/c3632a7f-5921-44d6-8700-823b1f416fb3.png)
...
![](assets/637c92b9-5e8e-4514-858e-e50f46a067ef.png)
...
![](assets/314f356e-4f40-4f08-bdfa-774e3fed800b.png)

现在，您只需进入命令提示符或终端会话，并输入`ssh`命令，开始与当前版本的交互式调试会话:

![](assets/c01641c2-0713-4800-9613-11bd4b50a804.png)

调试模式 SSH 会话将只保持活动状态 30 分钟，然后您需要进行另一个 API 调用来启动另一个调试会话:

![](assets/a12f5d24-ffc2-4d02-8eb8-ab1a47d01141.png)
...
![](assets/bc7fd32e-d1d9-4137-a655-05f8fe0545cd.png)
...
![](assets/fad602ad-6379-4c5e-aa32-9586c553be5a.png)
...
![](assets/c1441faa-cfc8-4d20-9bda-1c99dc1b0a90.png)
...
![](assets/932627c3-ee94-4ac2-88f0-9bdb7f71c989.png)
...
![](assets/1bc0b3c7-fa90-49a4-88ca-f89a59fd4bc7.png)
...
![](assets/31a527a2-d30f-499d-b488-3cd0441689d2.png)

我们只需要在 Heroku 中创建一个名为`multiple-languages`的应用，如下所示:

![](assets/ef039dd8-85f1-4d40-a42b-d29d2814a2ad.png)

现在让我们使用`travis restart`命令在 Travis 中重新开始构建:

![](assets/20ec2ee1-2e2f-417a-ace9-cbff5a19c3d9.png)

现在，让我们再次查看构建 8.1 的作业日志:

![](assets/db2db9ef-7069-430a-897e-28261c3cbcb9.png)

现在，如果我们查看 Heroku 仪表板，我们可以确认我们的应用程序已成功部署到 Heroku:

![](assets/03ae8c19-ca4c-40b6-81f9-aaad49942575.png)

...
![](assets/2e5d2e3e-f37b-4356-927d-2c001b684e2b.png)
...
![](assets/67e6728d-ee02-414c-a6b7-a3c8eb22e1f3.png)
...
![](assets/b9cf3e70-6862-46b8-bfc7-26d2374f5d68.png)
...
![](assets/b9b84382-b46d-4674-ab85-9d64b56173fb.png)

# 版本命令

`version`命令输出您在本地系统上安装的当前版本的命令行界面:

![](assets/de730070-ae1c-42ac-8b74-1d24e0ef3032.png)

您也可以在命令行界面中为每个命令传递一个标志/选项，您可以通过运行`--help`标志来找到命令的选项:

![](assets/42c7f35c-48e2-48bd-998a-fcd9188d6ea0.png)
...
![](assets/fc870348-c0c8-412d-9fd4-a62c926e929e.png)
...
![](assets/14bdd3d0-5df0-4e41-aacf-aaa0b0d555c1.png)
...
![](assets/c4d99005-c7f1-4ce5-94b5-115781f8e0fd.png)
...
![](assets/57677a87-6dc3-49e9-8113-0de69a9c0863.png)
...
![](assets/352fae0a-159c-40e6-b69d-be17fc023ba7.png)
...
![](assets/d0cbff8c-3ea5-4b78-9047-030e15dec87b.png)
...
![](assets/3cb68165-ad8a-4945-9822-1dce13ec5dd7.png)

现在我们知道我们的配置 YML 脚本仍然有效，我们可以使用带有`build`命令的`--job string`标志运行新作业。

![](assets/51212ff6-1664-4cd8-a934-c4ce2bef6c02.png)
...
![](assets/8029ac68-e023-49fb-9ae3-e6cb97c53c96.png)
...
![](assets/b52aeda5-fd1e-4896-b976-68edc24f0cf5.png)

单击用户设置链接后，您将被重定向到如下所示的帐户应用编程接口页面:

![](assets/7e9b20cb-f2ed-4f3b-9aa7-477a40725725.png)

接下来，您需要点击“创建新令牌”按钮，它会弹出如下模式:

![](assets/c710dd6e-0d34-4470-8940-8044863841c4.png)
...
![](assets/c3d3c273-d75e-424f-a810-3586cbf79dc5.png)
...
![](assets/976efbd2-7629-4cbd-8165-808896377642.png)
...
![](assets/a1396e90-838a-4cf3-ac36-01701e16b79b.png)
...
![](assets/a9b667b7-79ee-4b5b-bf55-01c74a56b22c.png)

如果单击运行工作流，您将看到以下页面:

![](assets/97bbc387-2a2f-4664-bbc4-83b686d00cb5.png)
...
![](assets/66fc9596-b687-45d3-ad52-a4c1640dacc5.png)

单击齿轮图标后，您将被重定向到“项目设置”页面，您需要单击“环境变量”链接。那么您的页面将如下图所示:

![](assets/adc3a7b8-517b-4dd3-ad0d-e7826c795c22.png)

我们将通过单击“添加变量”按钮向我们的项目添加两个环境变量，这将弹出一个如下所示的模式:

![](assets/9befa423-c161-4e90-92a7-4c87e656a223.png)
...
![](assets/02303299-1a33-42ee-acbf-d6477921db32.png)
...
![](assets/ec44ad31-573a-413f-bcf9-74d25ceb84c1.png)
...
![](assets/c394b673-bb14-4445-9d0b-cca3ef7d8d9c.png)
...
![](assets/9b06e7b2-40d1-4e8c-8d41-cc1e3f0f6729.png)
